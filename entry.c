...
static clasp_alias_t const Aliases[] = {
    ...
    CLASP_BIT_FLAG("-B", "--no-chomp-back", SISTOOL_CHOMP_F_NO_CHOMP_BACK, "suppresses chomping of trailing end-of-line sequence(s)"),
    CLASP_BIT_FLAG("-f", "--chomp-front", SISTOOL_CHOMP_F_CHOMP_FRONT, "chomps leading end-of-line sequence(s)"),
    CLASP_BIT_FLAG("-l", "--flatten", SISTOOL_CHOMP_F_FLATTEN_N, "flattens multiple consecutive end-of-line sequences"),
